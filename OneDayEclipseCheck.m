function [EclipseTable,Fraction,EclipseTableMoon,FractionMoon]=OneDayEclipseCheck(REarthSat,VEarthSat,EpochCheck)
if EpochCheck<2459945.5 || EpochCheck>2460311.5
    error('Pake tahun 2023 bang, soalnya gaada data yg lain')
end
T=readtable("MoonElement2023.csv",VariableNamingRule="modify");

t0=EpochCheck;
t1=EpochCheck+0.5; %ganti angka buat range ngitung
step=(t1-t0)*86400/0.1; %ganti yg di kanan buat stepnya
t=t0:(t1-t0)/step:t1;
